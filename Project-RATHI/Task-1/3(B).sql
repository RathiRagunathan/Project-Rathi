...
SELECT s.STU_NAME, c.COURSE_NAME FROM StudentInfo AS s
INNER JOIN EnrollmentInfo AS e ON s.STU_ID = e.STU_ID
INNER JOIN CoursesInfo AS c ON e.COURSE_ID = c.COURSE_ID
Where STU_NAME = 'Saro' AND ENROLL_STATUS = 'ENROLLED';
